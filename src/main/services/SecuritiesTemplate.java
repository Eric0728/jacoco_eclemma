...
import com.hsbc.hase.digital.securities.exception.stock.StockRestClientException;
import com.hsbc.hase.digital.securities.resp.stock.Response;
	...
	public <T extends Response> T postForObject(HttpMethod method, String url, Object request, Class<T> responseType,	Object... urlVariables){
        ...
        try {
			...
			result = responseEntity.getBody();
 			...
 			//SecuritiesTemplate.LOG.error(sb.toString(), rce);
			...
			this.handleRestClientException(method.toString(), url, request, responseType, rce, urlVariables);
 			...
 			//StringBuilder sb = new StringBuilder();
 			//SecuritiesTemplate.LOG.error(sb.toString(), ex);
